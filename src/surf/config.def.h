...
static Key keys[] = {
    ...
    { GDK_MOD1_MASK,         GDK_KEY_q,                    spawn,              QSEARCH() },
    { GDK_MOD1_MASK,         GDK_KEY_W,      			   spawn,              SR_SEARCH() },
    ...
    // navigate history
	{ MODKEY,                GDK_KEY_backslash,            navigate,           { .i = +1 } },
	{ MODKEY,                GDK_KEY_semicolon,            navigate,           { .i = -1 } },

	 // vertical and horizontal scrolling, in viewport percentage 
    { GDK_MOD1_MASK,         GDK_KEY_apostrophe,           scrollv             { .i = +10 } },
    { GDK_MOD1_MASK,         GDK_KEY_bracketleft,          scrollv             { .i = -10 } },
	{ MODKEY,                GDK_KEY_i,                    scrollh,            { .i = +10 } },
	{ MODKEY,                GDK_KEY_u,                    scrollh,            { .i = -10 } },


	{ GDK_SHIFT_MASK,        GDK_KEY_minus,                zoom,               { .i = -1 } },
	{ GDK_SHIFT_MASK,        GDK_KEY_equals,               zoom,               { .i = +1 } },
